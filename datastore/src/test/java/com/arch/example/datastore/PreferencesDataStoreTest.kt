...
import com.arch.example.datastore.test.testPreferencesDataStore
...
class PreferencesDataStoreTest {
    ...
    @Before
    fun setup() {
        subject = PreferencesDataStoreImpl(
            tmpFolder.testPreferencesDataStore(testScope.backgroundScope),
        )
    }
